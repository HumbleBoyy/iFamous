...
const PostForm = ({ post, action }:PostFormProps) => {
  ...
  const {toast} = useToast()
   ...
   const {mutateAsync: updatedPost, isPending: isLoadingUpdate} = useUpdatePost()
    // 1. Define your form.
  ...
  return (
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-9 w-full max-w-5xl">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className='shad-form_label'>Upload+</FormLabel>
              <FormControl>
                <FileUploader
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="text"
                   className='shad-input'
                   placeholder='Add a litlle bit information'
                   {...field}
                />
              </FormControl>
              <FormMessage  className='shad-form_message'/>
